...
const Checkout = () => {
  const {getCartItemsWithProducts, updatedQuantity, removeFromCart, getCartTotal,clearCart} = useCart()
              ...
              <div className='checkout-item' key={item.id}>
                ...
                <div className="checkout-item-controls">
                  <div className="quantity-controls">
                    <button className='quantity-btn' onClick={()=>updatedQuantity(item.id , item.quantity - 1)}>-</button>
